...
export default async function ChapterPage({ params }: { params: { slug: string } }) {
  ...
  const content = getChapterContent('part-4', params.slug)
  ...
  return (
    <article>
      ...
      <ChapterNav currentPart="part-4" currentSlug={params.slug} />
    </article>
  )
}
